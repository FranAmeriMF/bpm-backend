...
export declare class DecisionesController {
    private readonly decisionesService;
    constructor(decisionesService: DecisionesService);
    getPendientes(user: RequestUser, query: QueryDecisionesDto): Promise<{
        data: ({
            empresa: {
                id: string;
                razon_social: string;
    ...
    getHistorial(user: RequestUser, query: QueryDecisionesDto): Promise<{
        data: ({
            tramite: {
                empresa: {
                    id: string;
