...
export declare class TiposTramiteService {
    private readonly prisma;
    constructor(prisma: PrismaService);
    private findOrFail;
    private checkNombreUnico;
    private requireBorrador;
    ...
    reorderSecciones(id: string, ordenIds: string[]): Promise<{
        secciones: ({
            campos: {
                id: string;
                nombre: string;
    ...
    reorderCampos(id: string, seccion_id: string, ordenIds: string[]): Promise<{
        secciones: ({
            campos: {
                id: string;
                nombre: string;
