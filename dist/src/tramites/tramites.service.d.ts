...
export declare class TramitesService {
    ...
    findAll(query: QueryTramitesDto, currentUser?: import('../auth/decorators/current-user.decorator').RequestUser): Promise<{
        data: ({
            empresa: {
                id: string;
                razon_social: string;
    ...
    enviarDirector(id: string, solicitante_id: string): Promise<{
        id: string;
        estado: import("@prisma/client").$Enums.TramiteEstado;
        fecha_creacion: Date;
        empresa_id: string;
    ...
    aprobarDirector(id: string, director_id: string): Promise<{
        id: string;
        estado: import("@prisma/client").$Enums.TramiteEstado;
        fecha_creacion: Date;
        empresa_id: string;
    ...
    rechazarDirector(id: string, director_id: string, observaciones: string): Promise<{
        id: string;
        estado: import("@prisma/client").$Enums.TramiteEstado;
        fecha_creacion: Date;
        empresa_id: string;
    ...
    asignar(id: string, dto: AsignarTramiteDto, moderador_id: string): Promise<{
        tramite: {
            id: string;
            estado: import("@prisma/client").$Enums.TramiteEstado;
            fecha_creacion: Date;
    ...
    iniciarRevision(id: string, user: import('../auth/decorators/current-user.decorator').RequestUser): Promise<{
        id: string;
        estado: import("@prisma/client").$Enums.AsignacionEstado;
        oficina_id: string;
        fecha_asignacion: Date;
    ...
    finalizarRevision(id: string, user: import('../auth/decorators/current-user.decorator').RequestUser): Promise<{
        mensaje: string;
    }>;
    decisionFinal(id: string, dto: DecisionFinalDto, jefeDecisorId: string): Promise<{
        decision: {
            id: string;
            jefe_decisor_id: string;
            decision: import("@prisma/client").$Enums.DecisionTipo;
    ...
    iniciarCorreccion(id: string, solicitante_id: string): Promise<{
        id: string;
        estado: import("@prisma/client").$Enums.TramiteEstado;
        fecha_creacion: Date;
        empresa_id: string;
    ...
    reenviar(id: string, solicitante_id: string, secciones: TramiteSeccionDto[]): Promise<{
        id: string;
        estado: import("@prisma/client").$Enums.TramiteEstado;
        fecha_creacion: Date;
        empresa_id: string;
